...
export const examResults: TermResult[] = [
  {
    ...
    results: [
      ...
      { subject: "Geography", score: 67, max: 100, grade: "B", passMark: 40, teacherComment: "Diagram work has improved a lot this term." },
      { subject: "Mandarin", score: 72, max: 100, grade: "B+", passMark: 40 },
      { subject: "ICT", score: 95, max: 100, grade: "A", passMark: 40, teacherComment: "The digital-safety poster is going on the department wall." },
      { subject: "History", score: 34, max: 100, grade: "F", passMark: 40, teacherComment: "Essay structure needs work — see me Thursdays." },
    ],
    classTeacherComment:
      "A solid term across eight subjects. The History result is the one to focus on — the Thursday support session is the fastest fix.",
  },
  {
    ...
    results: [
      ...
      { subject: "Geography", score: 61, max: 100, grade: "C+", passMark: 40 },
      { subject: "Mandarin", score: 70, max: 100, grade: "B", passMark: 40 },
      { subject: "ICT", score: 92, max: 100, grade: "A", passMark: 40 },
...
export const studySeed: StudyResource[] = [
  {
    ...
    note: "Watch before attempting exercise 4.2. Pause and try each example yourself.",
    url: "https://www.youtube.com/results?search_query=quadratic+equations+visual+completion+of+the+square",
    sharedBy: "Mr. Tan",
    sharedAt: at(-1, 16, 0),
  },
  {
    ...
    kind: "Quiz",
    subject: "Science",
    title: "Quiz: neutralisation reactions",
    note: "Live game in class on Thursday — play a round at home so the format feels familiar.",
    url: "https://quizlet.com/search?query=neutralisation+reactions",
    sharedBy: "Mr. Raj",
    sharedAt: at(-2, 10, 30),
  },
  {
    ...
    url: "https://www.bbc.co.uk/bitesize/articles/z9y9kmn#~:text=PEEL",
    sharedBy: "Ms. Wong",
    sharedAt: at(-3, 9, 0),
  },
  {
    ...
    kind: "Video",
    subject: "Geography",
    title: "River processes: erosion & deposition",
    note: "Watch before diagrams 3–4 — the meander animation at 4:30 is the one from class.",
    url: "https://www.youtube.com/results?search_query=river+processes+erosion+deposition+animation",
    sharedBy: "Mr. Wood",
    sharedAt: at(-2, 11, 0),
  },
  {
    ...
    kind: "Reading",
    subject: "History",
    title: "Malayan Union — the documents",
    note: "Primary sources from 1946, the ones the source-analysis homework draws from.",
    url: "https://www.nlb.gov.sg/main/article-detail?cmsuuid=CR-2019-04-0159",
    sharedBy: "Mr. Lim",
    sharedAt: at(-3, 13, 0),
  },
  {
    ...
    kind: "Practice",
    subject: "ICT",
    title: "Typing club: home row speed set",
    note: "Fifteen minutes, three nights a week — accuracy first, speed follows.",
  ...
  },
  {
    ...
    kind: "Quiz",
    subject: "Mathematics",
    title: "Quiz: factorising quadratics",
    note: "Warm-up set — the live game in class uses the same question style.",
    url: "https://quizlet.com/search?query=factorising+quadratics",
    sharedBy: "Mr. Tan",
    sharedAt: at(-5, 14, 30),
  },
  {
    ...
    kind: "Video",
    subject: "Mandarin",
    title: "Stroke order: chapter 5 characters",
    note: "Each character twice, slow then fast — copy along once.",
    url: "https://www.youtube.com/results?search_query=chinese+stroke+order+practice+for+beginners",
    sharedBy: "Ms. Chen",
    sharedAt: at(-6, 9, 0),
  },
  {
    ...
    note: "The summary video from class — the documents above go deeper.",
    url: "https://www.youtube.com/results?search_query=malayan+union+malaysia+explained",
    sharedBy: "Mr. Lim",
    sharedAt: at(-4, 14, 0),
  },
  {
  ...
  },
  {
    ...
    url: "https://www.goodreads.com/list/tag/middle-grade",
    sharedBy: "Ms. Wong",
    sharedAt: at(-6, 12, 0),
  },
  {
    ...
    kind: "Quiz",
    subject: "Bahasa Malaysia",
    title: "Quiz: komsas bab 3",
    note: "Play once before Thursday's komsas test.",
    url: "https://quizlet.com/search?query=komsas+bab+3",
    sharedBy: "Pn. Aida",
    sharedAt: at(-7, 15, 0),
  },
  {
    ...
    url: "https://www.youtube.com/results?search_query=titration+technique+step+by+step",
    sharedBy: "Mr. Raj",
    sharedAt: at(-8, 9, 30),
  },
];
